...
- (void) loadView {
	...
	label.text = NSLocalizedString(@"Por favor espere…", nil);
	...
	UINavigationItem				*navItem = [[[UINavigationItem alloc] initWithTitle: NSLocalizedString(@"Cuenta de Twitter", nil)] autorelease];
    ...
    navItem.leftBarButtonItem = [[[UIBarButtonItem alloc] initWithTitle:@"Cancelar" style:UIBarButtonItemStyleBordered target:self action: @selector(cancel:)] autorelease ];
